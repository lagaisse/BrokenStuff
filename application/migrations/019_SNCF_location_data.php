...
class Migration_SNCF_Location_data extends CI_Migration {
    public function up(){
        ...
        $ret=$ret && $this->db->simple_query("insert into ".$this->db->dbprefix('location')." (lo_code,lo_name,lo_path) VALUES ('SNCF:87681395','LE BRAS DE FER - Evry Génopole','001004035')");
